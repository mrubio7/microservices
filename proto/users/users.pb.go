...
var file_proto_users_proto_rawDesc = []byte{
	...
	0x32, 0xce, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x65, 0x42, 0x13, 0x5a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73,
...
var file_proto_users_proto_depIdxs = []int32{
	...
	0, // 7: users.UserService.GetUser:output_type -> users.User
	0, // 8: users.UserService.GetUserByFaceitId:output_type -> users.User
	0, // 9: users.UserService.GetUserByPlayerNickname:output_type -> users.User
	0, // 10: users.UserService.UpdateUser:output_type -> users.User
	0, // 11: users.UserService.NewUser:output_type -> users.User
	2, // 12: users.UserService.NewSession:output_type -> users.NewSessionResponse
