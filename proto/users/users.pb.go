...
func (x *StreamsResponse) GetStreams() []string {
	if x != nil {
		return x.Streams
	}
	return nil
...
var file_proto_users_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x22, 0x2b, 0x0a, 0x0f, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x22,
	0x23, 0x0a, 0x11, 0x4e, 0x65, 0x77, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x02, 0x69, 0x64, 0x22, 0x30, 0x0a, 0x12, 0x4e, 0x65, 0x77, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x28, 0x09, 0x52, 0x02, 0x49, 0x64, 0x32, 0xcb, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x0d, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x12, 0x0c,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x16, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x13, 0x5a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x73,
...
var file_proto_users_proto_goTypes = []any{
	...
	(*NewSessionRequest)(nil),  // 3: users.NewSessionRequest
	(*NewSessionResponse)(nil), // 4: users.NewSessionResponse
	(*NewUserRequest)(nil),     // 5: users.NewUserRequest
	(*GetUserRequest)(nil),     // 6: users.GetUserRequest
	(*players.Player)(nil),     // 7: players.Player
}
var file_proto_users_proto_depIdxs = []int32{
	7, // 0: users.User.Player:type_name -> players.Player
	6, // 1: users.UserService.GetUser:input_type -> users.GetUserRequest
	6, // 2: users.UserService.GetUserByFaceitId:input_type -> users.GetUserRequest
	6, // 3: users.UserService.GetUserByPlayerNickname:input_type -> users.GetUserRequest
	0, // 4: users.UserService.UpdateUser:input_type -> users.User
	5, // 5: users.UserService.NewUser:input_type -> users.NewUserRequest
	3, // 6: users.UserService.NewSession:input_type -> users.NewSessionRequest
	3, // 7: users.UserService.DeleteSession:input_type -> users.NewSessionRequest
	1, // 8: users.UserService.GetAllStreams:input_type -> users.Empty
	0, // 9: users.UserService.GetUser:output_type -> users.User
	0, // 10: users.UserService.GetUserByFaceitId:output_type -> users.User
	0, // 11: users.UserService.GetUserByPlayerNickname:output_type -> users.User
	0, // 12: users.UserService.UpdateUser:output_type -> users.User
	0, // 13: users.UserService.NewUser:output_type -> users.User
	4, // 14: users.UserService.NewSession:output_type -> users.NewSessionResponse
	4, // 15: users.UserService.DeleteSession:output_type -> users.NewSessionResponse
	2, // 16: users.UserService.GetAllStreams:output_type -> users.StreamsResponse
