...
type Match struct {
	...
	ScoreTeamA   bool                    `protobuf:"varint,6,opt,name=ScoreTeamA,proto3" json:"ScoreTeamA,omitempty"`
	...
	ScoreTeamB   bool                    `protobuf:"varint,10,opt,name=ScoreTeamB,proto3" json:"ScoreTeamB,omitempty"`
...
func (x *Match) GetScoreTeamA() bool {
	if x != nil {
		return x.ScoreTeamA
	}
	return false
...
func (x *Match) GetScoreTeamB() bool {
	if x != nil {
		return x.ScoreTeamB
	}
	return false
...
var file_proto_matches_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x41, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x53, 0x63, 0x6f, 0x72, 0x65,
	...
	0x6f, 0x72, 0x65, 0x54, 0x65, 0x61, 0x6d, 0x42, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a,
	...
	0x69, 0x74, 0x49, 0x64, 0x32, 0x85, 0x01, 0x0a, 0x0e, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73,
	...
	0x65, 0x73, 0x2e, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x12,
	0x47, 0x65, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x42, 0x79, 0x46, 0x61, 0x63, 0x65, 0x69, 0x74,
	0x49, 0x64, 0x12, 0x18, 0x2e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74,
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x6d,
	0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x2e, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x42, 0x1e, 0x5a, 0x1c,
	0x69, 0x62, 0x65, 0x72, 0x63, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x61, 0x74,
	0x63, 0x68, 0x65, 0x73, 0x3b, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_matches_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_matches_proto_goTypes = []any{
	...
	(*teams.Team)(nil),             // 4: teams.Team
	(*tournaments.Tournament)(nil), // 5: tournaments.Tournament
}
var file_proto_matches_proto_depIdxs = []int32{
	4, // 0: matches.Match.TeamA:type_name -> teams.Team
	4, // 1: matches.Match.TeamB:type_name -> teams.Team
	5, // 2: matches.Match.Tournament:type_name -> tournaments.Tournament
	0, // 3: matches.MatchList.Matches:type_name -> matches.Match
	2, // 4: matches.MatchesService.GetAllMatches:input_type -> matches.Empty
	3, // 5: matches.MatchesService.GetMatchByFaceitId:input_type -> matches.GetMatchRequest
	1, // 6: matches.MatchesService.GetAllMatches:output_type -> matches.MatchList
	0, // 7: matches.MatchesService.GetMatchByFaceitId:output_type -> matches.Match
